    ...
    return (
        <div className="overflow-x-auto md:flex md:justify-center ">
            ...
            style={{ width: '794px', height: '1123px' }}>
                <h1 className="font-bold text-4xl">{userData.name || "Elguja Modebadze"}</h1>
                <h2 className="font-bold text-3xl ">{userData.profession || "Frontend developer"}</h2>
                ...
                <div className="flex">
                    <div className="border-r border-gray-300 pr-5">
                        <div className="mb-10"> {/*DETAILS */}
                            ...
                            <h3 className="text-xl mb-5">{userData.location || "Tbilisi, Georgia"}</h3>

                            <h3 className="font-semibold text-xl">PHONE</h3>
                            <h3 className="text-xl mb-5">{userData.phone || "+995 599 99 99 99"}</h3>

                            <h3 className="font-semibold text-xl">EMAIL</h3>
                            <h3 className="text-xl mb-5">{userData.email || "emodebadze9108@sdsu.edu"}</h3>
                        </div>
